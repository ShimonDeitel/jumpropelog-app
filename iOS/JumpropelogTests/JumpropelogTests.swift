import XCTest
@testable import Jumpropelog

@MainActor
final class JumpropelogTests: XCTestCase {
    ...
    func testAddEntry() {
        ...
        store.add(style: "Basic", value1: 10, value2: 5)
    ...
    func testAddRespectsFreeLimit() {
        ...
        for i in 0..<Store.freeLimit {
            store.add(style: "Basic", value1: i, value2: 1)
        }
        let result = store.add(style: "Basic", value1: 1, value2: 1)
    ...
    func testDeleteEntry() {
        let store = Store()
        store.entries = []
        store.add(style: "Basic", value1: 1, value2: 1)
    ...
    func testDeleteAtOffsets() {
        ...
        store.entries = []
        store.add(style: "Basic", value1: 1, value2: 1)
        store.add(style: "Basic", value1: 2, value2: 2)
